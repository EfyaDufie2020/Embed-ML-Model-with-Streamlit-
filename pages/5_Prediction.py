...
if prediction is None:
    ...
    st.markdown(f'### The customer will leave the company with a probability of {round(probability_of_yes, 2)}%')
else:
    probability_of_no = probability[0][0] * 100
    st.markdown(f'### The customer will not leave the company with a probability of {round(probability_of_no, 2)}%')
